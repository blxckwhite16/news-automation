...
- **무인 기상 신뢰성의 핵심은 S4(Hibernate) 자체가 아니라 `StartBoundary` catch-up buffer다 [2026-08-14 정정]** — S0(2026-08-12)와 S4(2026-08-14) 양쪽 모두 StartBoundary를 n8n 트리거보다 충분히 앞당긴 조건에서 실제로 성공한 것을 확인해, "S4가 필수조건"이라는 이전 결론을 철회했다. S4는 여전히 채택된 운영 방식이지만, 그 근거를 "필수"가 아니라 "실측으로 신뢰성이 확인된 선택지"로 낮춰 잡는다 (8.4절).
